...
estimate_cGrammatical <- print_estimate_with_ci( m_responses_full, 'cGrammatical' )
estimate_cGrammatical_cAttractorPlural <- print_estimate_with_ci( m_responses_full, 'cGrammatical:cAttractorPlural')
estimate_threeway_interaction <- print_estimate_with_ci( m_responses_full, 'cEndsInConsonant:cGrammatical:cAttractorPlural')
